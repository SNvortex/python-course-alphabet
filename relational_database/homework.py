...
def task_11_list_customers_starting_from_11th(cur):
    ...
    Returns: 11 records
    """
    cur.execute("SELECT * FROM customers WHERE customerid > 11 LIMIT 11;")
...
def task_14_list_products_with_supplier_information(cur):
    ...
    Returns: 77 records
    """
    cur.execute("""SELECT products.productname, suppliers.suppliername, suppliers.contactname, suppliers.phone, suppliers.address, suppliers.city 
                    FROM products 
...
def task_15_list_customers_with_any_order_or_not(cur):
    ...
    Returns: 213 records
    """
    cur.execute("""SELECT customers.customername, orders.orderid FROM customers 
